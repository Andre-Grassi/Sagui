...
# Reseta R[0]
movl 0000   # R[1] = {R[1](7:4) + Imm.} = {0000 + 0000} = 00000000 = 0 --> 10000000 = 80

# Coloca o valor -16 no R[0]
movh 1111   # R[1] = {Imm + R[1](3:0)} = {1111 + 0000} = 11110000 = -16 --> 01111111 = 7F
...
######## SHIFT ########
# R[1] = 1
movh 0000   # R[1] = {Imm + R[1](3:0)} = {0000 + 0000} = 00000000 = 0 --> 01110000 = 70
movl 0001   # R[1] = {R[1](7:4) + Imm.} = {0000 + 0001} = 00000001 = 1 --> 10000001 = 81
...
# R[0] = 7 = 00000111
movl 0111  # R[1] = {R[1](7:4) + Imm.} = {0000 + 0111} = 00000111 = 7 --> 10000111 = 87
