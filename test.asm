...
# R[1] = 1
sub $0, $0  # R[0] = R[0] - R[0] # Reseta o registrador 0 --> 10100000 = A0
movl 1      # R[0] = {R[0](7:4) + Imm.} = {0000 + 0001} = 00000001 = 1 --> 10000001 = 
movr $1, $0 # R[1] = R[0] = 1 --> 01100100 =

# Multiplica R[1] por 2
slr $1, $0 # R[1] = R[1] << R[0] = 1 << 1 = 2

# Divide R[1] por 2
srr $1, $0 # R[1] = R[1] >> R[0] = 2 >> 1 = 1

# R[0] = 7 = 00000111
movl 7 # R[0] = {R[0](7:4) + Imm.} = {0000 + 0111} = 00000111 = 7 --> 10000111 =

# Máximo de slr possível, causando overflow
slr $1, $0 # R[1] = R[1] << R[0] = 1 << 7 = -128
